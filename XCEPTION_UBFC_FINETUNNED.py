...
opt = RAdam(learning_rate=0.0001, weight_decay=0.01)
opt = Adam(learning_rate=0.001, decay=0.1)

#1-opt = RAdam(learning_rate=0.00001, weight_decay=0.1)
#1-opt = RAdam(learning_rate=0.0001, weight_decay=0.01)
...
sgd = SGD(learning_rate=0.000000002, momentum=0.9, nesterov=True)
...
checkpoint = ModelCheckpoint('weights_XCEPTION_augmented__{epoch:02d}.h5',
                             monitor='val_root_mean_squared_error',
                             verbose=1, save_best_only=False)
history_checkpoint = CSVLogger("history_augmented_ubfc+bp4d2.csv", append=True)
