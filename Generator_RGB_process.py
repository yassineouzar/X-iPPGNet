...
class DirectoryIterator(Iterator):
    ...
    def __init__(self, directory, image_data_generator,
        ...
        for ti in classes_hr:
            ...
            heart_rate = [filename for filename in list_dir2 if filename.startswith("Pul")]
    ...
    def next(self):
        ...
        for i in range(int(len(index_array))):
            ...
            x = cv2.normalize(img, None, 0, 1, cv2.NORM_MINMAX)


            batch_x1[i] = x
        #batch_x = batch_x1.reshape(-1, self.frames_per_step, 160, 120, 3)
...
if __name__ == '__main__':
    ...
    train_data = datagen.flow_from_directory(directory='/home/ouzar1/Desktop/Dataset1/Validation_MMSE/ROI_val1',
                                              label_dir='/home/ouzar1/Desktop/Dataset1/Validation_MMSE/HR_val', target_size=(160, 120), class_mode='label', batch_size=20, frames_per_step=50, shuffle=False)
